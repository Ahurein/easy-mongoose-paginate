...
exports.easyMongoosePaginateConfig = void 0;
...
const easyMongoosePaginateConfig = {
    globalOptions: {},
};
exports.easyMongoosePaginateConfig = easyMongoosePaginateConfig;
...
async function paginateQuery(filterQuery, filter) {
...
async function paginateAggregate(stage, filter) {
    const filterQuery = {
        ...defaultFilterValues,
        ...easyMongoosePaginateConfig.globalOptions,
        ...filter
